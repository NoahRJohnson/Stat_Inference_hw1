...
\begin{itemize}
   ...
   \begin{itemize}
     \item No, the likelihood does not 
   \end{itemize}
...
In MLE we always want to choose parameter values which maximize the probability of observing our data. Log is a strictly increasing function, so to maximize the likelihood, we should choose the maximum log likelihood value. Of the four $p_B$ possibilities, $p_B = 0.5075$ 
